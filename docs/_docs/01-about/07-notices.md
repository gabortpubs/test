...
© (_your company name_) (_year_). <br />
Portions of this code are derived from IBM Corp. Sample Programs.<br />
...
**DRAFT COMMENT:** _Review your product to determine whether it collects personally identifiable information through cookies or similar technologies. Consult with your local Intellectual Property attorney for appropriate language to reflect your product features.  Download and extract the cookie guidance file in  "Legal notices for product documentation" (http://rtpdoc01.rtp.raleigh.ibm.com:9083/kc/idibm/com.ibm.utic.publishing.doc/doc/notices_books.html). Remove this section if it does not apply to your product._
